...
public abstract class HeadDecoration extends ItemDecoration {
    ...
    private OnGestureListener gestureListener = new OnGestureListener() {
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            for (int i = 0; i < HeadDecoration.this.stickyHeaderPosArray.size(); ++i) {
                int value = (Integer) HeadDecoration.this.stickyHeaderPosArray.valueAt(i);
                float y = e.getY();
        ...
        if (this.gestureDetector == null) {
            ...
            recyclerView.setOnTouchListener(new OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    return HeadDecoration.this.gestureDetector.onTouchEvent(event);
                }
            });
        }
...
//                        canvas.drawText(curHeaderName, (float) (left + this.textPaddingLeft), (float) (viewTop - this.headerHeight / 2) + this.txtYAxis, this.mHeaderTxtPaint);
    ...
    public void onDestory() {
        ...
        this.setOnHeaderClickListener((OnHeaderClickListener) null);
        this.setOnDecorationHeadDraw((OnDecorationHeadDraw) null);
    }
